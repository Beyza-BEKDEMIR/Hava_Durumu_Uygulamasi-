...
const Anasayfa = () => {
    const { selectedCity } = useCity(); // seçili şehrin bilgisini anasayfada gösteriyor.
  ...
  const dayImages = {
    ...
    'Salı': require('../resim/02d.png'),
    'Çarşamba': require('../resim/01d.png'),
    'Perşembe': require('../resim/03d.png'),
    'Cuma': require('../resim/01d.png'),
    'Cumartesi': require('../resim/01d.png'),
    'Pazar': require('../resim/02d.png'),
  };
...
const kutuno = () => {
    ...
    for (let j = 0; j <= columns; j++) {
      ...
      boxes.push(
        <View key={index} style={[
          ...
          <Text style={styles.saatler}>{ index === 24 ? '00:00' : (index < 10 ? `0${index}:00` : `${index}:00`)}</Text>

          <Image
            style={styles.img}
            source={
              index >= 0 && index <= 5 ? require('../resim/04d.png') :
              index >= 12 && index <= 16 ? require('../resim/01d.png') :
              index >= 22 && index < 24 ? require('../resim/04d.png') :
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <TouchableOpacity style={styles.profileIcon} onPress={navigateToLogin}>
        <Icon name="sign-out" size={40} color={Colors.white} />
      </TouchableOpacity>
